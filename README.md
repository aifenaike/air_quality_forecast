...
You can find the more detailed doc on the main [notebook](time-series-forecasting-tutorial.ipynb) 
...
In order to obtain a exact copy of the dataset used in this tutorial please run the [script](https://github.com/aifenaike/air_quality_forecast/blob/main/datasets/download_datasets.py) under `datasets/download_datasets.py` which will automatically download the dataset and preprocess it for you.
